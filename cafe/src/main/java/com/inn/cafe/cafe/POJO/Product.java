...
@NamedQuery(name = "Product.getAllProduct", query = "SELECT new com.inn.cafe.cafe.wrapper.ProductWrapper(p.id,p.name,p.description,p.price,p.status,p.category.id,p.category.name) from Product p")
